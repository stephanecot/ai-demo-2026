# US-008 — Historique et consultation des CRA passés

**Prérequis** : US-003 — des CRA doivent avoir été saisis pour être consultés.
...
- La vue détaillée réutilise le composant calendrier de la saisie (US-003) en mode lecture seule.
