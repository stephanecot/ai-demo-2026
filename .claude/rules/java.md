---
description: >-
  Java 25 / Spring Boot 4 forbidden patterns (hard constraints) — the list of
  things to NEVER do in backend code. Apply when writing or reviewing any Java
  code in backend/.
paths:
  - "backend/**/*.java"
---
